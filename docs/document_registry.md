...
| [`project_gap_analysis.md`](project_gap_analysis.md) | 问题台账 | 0 号、5 号，领域负责人认领 | 当前，长期维护：以待发布 `v0.3.1` 为基线，登记当前 LLM 协议和真实工具闭环缺口 G-05/G-09；本地 mock 和服务端契约已通过，真实 BYOK 报告按当前口径留存。明确唯一真人开发者负责 AI 严格无法验证的真实环境矩阵；0-7 号均为受限 AI 协作角色。G09、科学体系预测、后处理/分析与离子 OPLS 均登记为本版本非目标。 | 2026-08-12 | 缺口修复、责任/严重度变化、外部依赖兼容性、稳定基线更新或发布前。 |
