...
用法:
  CLI:  python3 -m willy.simulation.md_em [work_dir]
  API:  from willy.simulation.md_em import run_em, EMResult
"""
...
from willy.simulation._md_utils import grompp_and_mdrun
...
def run_em(work_dir: str = None,
    ...
    if m:
        ...
        return StepResult(
            step_name="md_em", step_index=8, success=True,
