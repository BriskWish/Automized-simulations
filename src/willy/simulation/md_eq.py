...
用法:
  CLI:  python3 -m willy.simulation.md_eq [work_dir]
  API:  from willy.simulation.md_eq import run_eq, EQResult
"""
...
from willy.simulation._md_utils import grompp_and_mdrun, check_last_fraction
...
def run_eq(work_dir: str = None,
    ...
    if not cwd.exists():
        return StepResult(
            step_name="md_eq", step_index=9, success=False,
    ...
    if converged:
        return StepResult(
            step_name="md_eq", step_index=9, success=True,
