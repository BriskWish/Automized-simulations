...
_TEST_LAYER_BY_FILE = {
    ...
    "test_resume_admission.py": "integration",
    "test_step_contracts.py": "contract",
    "test_input_declaration.py": "contract",
    "test_controlled_launch.py": "integration",
    "test_branching.py": "contract",
    "test_simulation_execution.py": "integration",
    "test_eq_acceptance.py": "integration",
    "test_gmx_process.py": "integration",
